...
def run_maven_command():
    ...
    try:
        ...
        # Changed the project directory from 'mapdata-db' to 'mapdata-api'
        project_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'mapdata-api')
        ...
        print(f"\n{EMOJI['success']} Packageing of the mapdata-api Completed Successfully")
